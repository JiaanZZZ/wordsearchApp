...
})({"kQOW7":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "76e4095d786e91cf";
...
},{}],"7vfJ4":[function(require,module,exports) {
...
},{"./grid":"g31Jt"}],"g31Jt":[function(require,module,exports) {
...
class Grid {
    ...
    getCellsInRange(firstLetter, currentLetter) {
        ...
        if (firstLetter.y === currentLetter.y) for(let i = firstLetter.x; i <= currentLetter.x; i++)cellsInRange.push(this.gridArea.querySelector(`td[data-x="${i}"][data-y="${currentLetter.y}"]`));
            ...
            for(let i2 = 0; i2 <= delta; i2++)cellsInRange.push(this.gridArea.querySelector(`td[data-x="${currentLetter.x + i2}"][data-y="${firstLetter.y + i2}"]`));
        }
        return cellsInRange;
    }
    renderGrid(gridSize, wordGrid) {
        ...
        tbl.addEventListener("mouseup", (event)=>{
            ...
            else if (this.words.indexOf(reversedSelectedWord.r) !== -1) this.foundWords.push(reversedSelectedWord);
...
},{}]},["kQOW7","7vfJ4"], "7vfJ4", "parcelRequire94c2")

//# sourceMappingURL=index.786e91cf.js.map
